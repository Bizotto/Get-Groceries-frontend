...
export function Login() {
  return (
    <a
      ...
      className="flex items-center gap-3 text-left hover:text-secondary-300 transition-colors"
    >
      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-greenTransparent">
        <User className="h-5 w-5 text-secondary-300" />
      </div>
      <p className="max-w-[140px] text-sm leading-snug text-black max-md:hidden max-sm:hidden">
